...
\textbf{Se} $D(A)$ è \textbf{denso} in $\hs$ (cosa che abbiamo assunto per tutti gli osservabili), per determinare $A$ possiamo dare\marginpar{Elementi di matrice di un operatore con dominio denso} gli \q{elementi di matrice di $A$}, ossia 
\[
...
\lesson{19}{9/11/2018}
(Questa lezione sarà aggiunta prossimamente)
