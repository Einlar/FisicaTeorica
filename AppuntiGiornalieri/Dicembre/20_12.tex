...
Visto che, all'apertura della scatola, il risultato è per $|\alpha_+|^2$ gatto vivo e per $|\alpha_-|^2$ gatto morto e non abbiamo nessuna interferenza tra i due, potremmo essere tentati di affermare che lo stato dopo la misura, ma prima dell'apertura della scatola, sia uno stato misto, in cui gli stati di \textit{gatto morto} e \textit{gatto vivo} sono \q{pesati} dalle probabilità $|\alpha_+|^2$ e $|\alpha_-|^2$:
\begin{align*}
