...
\begin{figure}[H]
\centering
\input{Plot/Trasmissione_maxmin.tex}
...
\begin{itemize}
\item 
\textbf{Radioattività} Consideriamo un nucleo di uranio $^{238}_{92}U$, dove i due\marginpar{Range dei tempi di decadimento $\alpha$} numeretti ad apice e pedice indicano rispettivamente il numero di nucleoni e di protoni:
\[
