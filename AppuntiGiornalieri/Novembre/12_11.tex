...
\begin{dfn}
Se $\hs_1$ \marginpar{Somma diretta} e $\hs_2$ sono spazi di Hilbert, l'insieme delle \textbf{coppie} $\hs_1 \oplus \hs_2 = \{\psi_1 \in \hs_1, \psi_2 \in \hs_2\}$ denotate $\psi_1 \oplus \psi_2$ con il prodotto scalare:
\[
