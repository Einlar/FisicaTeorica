...
Da queste considerazioni, possiamo formare un altro ICOC,\marginpar{2. ICOC $\{(\vec{J}^{(1)})^2, (\vec{J}^{(2)})^2, \vec{J}^{\,2}, \vec{J}_3\}$} dato da $\{(\vec{J}^{(1)})^2, (\vec{J}^{(2)})^2, \vec{J}^{\,2}, \vec{J}_3\}$, i cui autoket sono denotati con $\ket{j_1, j_2; j, m}$, oppure, quando è chiaro quali siano $j_1$ e $j_2$, semplicemente con $\ket{j,m}$.\\
