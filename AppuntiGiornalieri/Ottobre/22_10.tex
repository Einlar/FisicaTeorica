...
\]
che è impossibile perché $\bar{U}\left(t_1+t_2\right)$ è antiunitario, ma il prodotto di due operatori antiunitari $\bar{U}\left(t_1\right)\bar{U}\left(t_2\right)$ è unitario! (è come se stessi "invertendo il segno" due volte) %Dimostrare
