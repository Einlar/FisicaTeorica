...
\begin{axi}
La \textbf{probabilità}\marginpar{Assioma della probabilità}\index{Assioma!della probabilità} che una misura di $A$ nello stato $\psi$ (ricavata ripetendo tante volte la misura sperimentale nelle stesse condizioni) sia in $]-\infty , \lambda]$ è data da:
\[
