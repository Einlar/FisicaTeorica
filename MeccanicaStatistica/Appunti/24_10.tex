...
Prima di tutto, introduciamo un potenziale termico $A$ noto come \textbf{energia libera di Helmholtz},\marginpar{Energia libera di Helmholtz}\index{Potenziale di Helmholtz} definito come:
\[
A=E-TS
\]
...
\]
Da qui nasce l'appellativo di \textit{potenziale termodinamico}: a seguito di trasformazioni \q{libere} $A$ tende a diminuire - il sistema si \q{sposta} verso stati ad $A$ basso proprio come una particella carica positivamente tende ad andare verso i punti in cui il potenziale è minore.\\
